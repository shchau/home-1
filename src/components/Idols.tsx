        ...
        <Row>
          <Col xs={24} sm={12}>
            ...
            >
              <Meta
                title="Mattt"
                description="Founder of @Flight-School. Formerly @Apple, @NSHipster, @AFNetworking."
              />
            </Card>
          </Col>
          <Col xs={24} sm={12}>
        ...
        <Row>
          <Col xs={24} sm={12}>
            ...
            >
              <Meta
                title="Chris Lattner"
                description="Swift author. Former Senior Director and Architect at @Apple."
              />
            </Card>
          </Col>
          <Col xs={24} sm={12}>
            ...
            >
              <Meta
                title="John Sundell"
                description="Building apps, games and Swift developer tools! @Open Source @Developer Productivity."
              />
            </Card>
          </Col>
        </Row>
